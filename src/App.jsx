...
// // // //       <section className="px-4 sm:px-8 py-10 sm:py-20 text-center"><img src={SCHOOL_LOGO} alt="School Logo" className="w-24 h-24 sm:w-36 sm:h-36 mx-auto mb-6 sm:mb-8 rounded-full object-cover shadow-xl border-4 border-white" /><h2 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold mb-4 sm:mb-6 leading-tight">Welcome to <span className="text-blue-700">AIIMS</span></h2><p className="max-w-2xl mx-auto text-base sm:text-lg text-gray-600 mb-8 sm:mb-10 leading-relaxed">A modern school management and result portal where students can securely check results, notices, attendance, and more.</p><button onClick={() => setPage('student')} className="bg-blue-600 text-white px-8 py-4 rounded-2xl text-lg shadow-lg">Explore Dashboard</button></section>
// // // //       <section className="px-4 sm:px-8 pb-12 sm:pb-20"><div className={results.length ? 'max-w-7xl mx-auto bg-green-50 border border-green-200 rounded-3xl p-8 shadow-xl text-center' : 'max-w-7xl mx-auto bg-yellow-50 border border-yellow-200 rounded-3xl p-8 shadow-xl text-center'}><h3 className={results.length ? 'text-3xl font-bold text-green-700 mb-3' : 'text-3xl font-bold text-yellow-700 mb-3'}>{results.length ? '🎉 Congratulations! Latest results are now available.' : '📌 Results will be available soon.'}</h3><p className="text-gray-700 text-lg">{results.length ? 'Students can login using their roll number to check percentage, pass/fail status and rank.' : 'Please keep checking latest announcements for result updates.'}</p><button onClick={() => setPage('student')} className={results.length ? 'mt-6 bg-green-600 text-white px-8 py-4 rounded-2xl font-bold' : 'mt-6 bg-yellow-600 text-white px-8 py-4 rounded-2xl font-bold'}>{results.length ? 'Check Result Now' : 'Go to Student Login'}</button></div></section>
// // // //       <section className="px-4 sm:px-8 pb-12 sm:pb-20"><h3 className="text-3xl sm:text-4xl font-bold text-center mb-8 sm:mb-12">Portal Features</h3><div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">{['Secure Student Login', 'Online Result System', 'Bulk Upload', 'Admin Dashboard'].map((f) => <div key={f} className="bg-white p-8 rounded-3xl shadow-lg"><div className="text-5xl mb-4">📘</div><h4 className="text-xl font-bold mb-3">{f}</h4><p className="text-gray-600">Responsive system designed for students and school administration.</p></div>)}</div></section>
// // // //       <section className="px-4 sm:px-8 pb-12 sm:pb-20"><div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8"><div className="bg-white rounded-3xl shadow-xl p-6 sm:p-10"><p className="text-blue-700 font-bold mb-3">About Our School</p><h3 className="text-3xl sm:text-4xl font-bold mb-6 leading-tight">Building Bright Futures With Smart Learning</h3><p className="text-gray-600 text-base sm:text-lg leading-relaxed mb-6">AIIMS School focuses on discipline, quality education, digital learning, and student growth.</p><div className="grid grid-cols-1 sm:grid-cols-3 gap-4"><div className="bg-blue-50 p-5 rounded-2xl text-center"><h4 className="text-3xl font-bold text-blue-700">{students.length || '3000+'}</h4><p className="text-gray-600 text-sm mt-1">Students</p></div><div className="bg-green-50 p-5 rounded-2xl text-center"><h4 className="text-3xl font-bold text-green-700">12+</h4><p className="text-gray-600 text-sm mt-1">Classes</p></div><div className="bg-purple-50 p-5 rounded-2xl text-center"><h4 className="text-3xl font-bold text-purple-700">{results.length}</h4><p className="text-gray-600 text-sm mt-1">Results</p></div></div></div><div className="bg-blue-700 text-white rounded-3xl shadow-xl p-6 sm:p-10"><p className="font-bold opacity-90 mb-3">Admissions Open</p><h3 className="text-4xl font-bold mb-5">Admissions Open for 2026-27</h3><p className="text-blue-100 text-lg leading-relaxed mb-8">Contact the school office for admission details, fee structure, documents required, and class availability.</p><button onClick={() => setPage('student')} className="bg-white text-blue-700 px-6 py-3 rounded-2xl font-bold">Student Portal</button></div></div></section>
// // // //       <section className="px-4 sm:px-8 pb-12 sm:pb-20"><div className="max-w-7xl mx-auto"><h3 className="text-3xl sm:text-4xl font-bold text-center mb-3 text-blue-700">Top 3 Performers</h3><p className="text-center text-gray-500 mb-12">Only the best 3 students are shown here based on uploaded results.</p><div className="grid grid-cols-1 md:grid-cols-3 gap-8">{topResults.length ? topResults.map((r, index) => <div key={r.roll} className="bg-white rounded-3xl shadow-xl p-8 text-center"><div className="text-5xl mb-4">🏆</div><p className="text-gray-500 font-bold">Rank {index + 1}</p><h4 className="text-2xl font-bold mt-2">{r.studentName}</h4><p className="text-gray-500">Class {r.className} - Section {r.section}</p><div className="mt-5 bg-green-50 text-green-700 rounded-2xl p-4"><p className="text-sm font-semibold">Percentage</p><h5 className="text-3xl font-bold">{r.percent}%</h5></div></div>) : [1, 2, 3].map((x) => <div key={x} className="bg-white rounded-3xl shadow-xl p-8 text-center"><div className="text-5xl mb-4">🏆</div><h4 className="text-2xl font-bold">Topper Name</h4><p className="text-gray-500">Will appear after results are uploaded</p><div className="mt-5 bg-blue-50 text-blue-700 rounded-2xl p-4"><p className="font-semibold">Result Pending</p></div></div>)}</div></div></section>
// // // //       <section className="px-4 sm:px-8 pb-12 sm:pb-20"><div className="max-w-7xl mx-auto"><h3 className="text-3xl sm:text-4xl font-bold text-center mb-8 sm:mb-12">Upcoming Events</h3><div className="grid grid-cols-1 md:grid-cols-3 gap-8">{events.map((event) => <div key={event.title} className="bg-white rounded-3xl shadow-xl p-8"><div className="text-5xl mb-4">📅</div><h4 className="text-2xl font-bold text-blue-700 mb-2">{event.title}</h4><p className="font-semibold text-gray-500 mb-4">{event.date}</p><p className="text-gray-600 leading-relaxed">{event.detail}</p></div>)}</div></div></section>
// // // //       <section className="px-4 sm:px-8 pb-12 sm:pb-20"><div className="max-w-7xl mx-auto bg-white rounded-3xl shadow-xl p-6 sm:p-10"><h3 className="text-3xl sm:text-4xl font-bold text-center mb-8 sm:mb-10 text-blue-700">Parent Information</h3><div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">{parentInfo.map((info) => <div key={info.title} className="bg-blue-50 p-6 rounded-2xl"><h4 className="text-lg font-bold text-blue-700 mb-2">{info.title}</h4><p className="text-gray-700">{info.value}</p></div>)}</div></div></section>
// // // //       <section className="px-4 sm:px-8 pb-12 sm:pb-20"><div className="max-w-6xl mx-auto bg-white rounded-3xl shadow-xl p-5 sm:p-10"><h3 className="text-3xl sm:text-4xl font-bold text-center mb-8 sm:mb-10 text-blue-700 leading-tight">Frequently Asked Questions</h3><div className="space-y-4">{faqs.map((faq) => <div key={faq.question} className="bg-gray-50 p-5 sm:p-6 rounded-2xl"><h4 className="text-base sm:text-lg font-bold text-gray-800 mb-2 leading-snug">{faq.question}</h4><p className="text-sm sm:text-base text-gray-600 leading-relaxed">{faq.answer}</p></div>)}</div></div></section>
// // // //       <section className="px-4 sm:px-8 pb-12 sm:pb-20"><div className="max-w-6xl mx-auto bg-white rounded-3xl shadow-xl p-6 sm:p-10"><h3 className="text-3xl sm:text-4xl font-bold mb-8 text-center text-blue-700">Latest Announcements</h3><div className="space-y-4">{notices.map((n, i) => <div key={i} className="bg-blue-50 border-l-4 border-blue-700 p-5 rounded-2xl"><p className="font-medium text-lg">📢 {n}</p></div>)}</div></div></section>
...
// // // //   return <div className="min-h-screen bg-gray-100 text-gray-900 overflow-x-hidden"><header className="bg-white shadow sticky top-0 z-50"><div className="max-w-7xl mx-auto px-3 sm:px-6 py-3 sm:py-4 flex flex-row justify-between items-center gap-3"><div className="flex items-center gap-2 sm:gap-3 min-w-0"><img src={SCHOOL_LOGO} alt="School Logo" className="w-11 h-11 sm:w-12 sm:h-12 rounded-full object-cover shrink-0" /><div className="text-left min-w-0"><h1 className="text-sm sm:text-xl font-bold text-blue-700 leading-tight break-words">{SCHOOL_NAME}</h1><p className="hidden xs:block text-[10px] sm:text-xs text-gray-500 leading-tight">{SCHOOL_TAGLINE}</p></div></div><nav className="shrink-0 grid grid-cols-1 sm:flex gap-1 sm:gap-2 bg-blue-50/70 p-1.5 sm:p-2 rounded-2xl border border-blue-100 shadow-inner"><button onClick={() => setPage('home')} className={page === 'home' ? 'px-3 sm:px-5 py-2 rounded-xl bg-blue-600 text-white font-bold shadow-lg transition-all duration-300 text-xs sm:text-base' : 'px-3 sm:px-5 py-2 rounded-xl font-bold text-gray-700 hover:text-blue-700 hover:bg-white hover:shadow-md transition-all duration-300 text-xs sm:text-base'}>Home</button><button onClick={() => setPage('student')} className={page === 'student' || page === 'studentDashboard' ? 'px-3 sm:px-5 py-2 rounded-xl bg-blue-600 text-white font-bold shadow-lg transition-all duration-300 text-xs sm:text-base' : 'px-3 sm:px-5 py-2 rounded-xl font-bold text-gray-700 hover:text-blue-700 hover:bg-white hover:shadow-md transition-all duration-300 text-xs sm:text-base'}>Student</button><button onClick={() => setPage('admin')} className={page === 'admin' || page === 'adminDashboard' ? 'px-3 sm:px-5 py-2 rounded-xl bg-blue-600 text-white font-bold shadow-lg transition-all duration-300 text-xs sm:text-base' : 'px-3 sm:px-5 py-2 rounded-xl font-bold text-gray-700 hover:text-blue-700 hover:bg-white hover:shadow-md transition-all duration-300 text-xs sm:text-base'}>Admin</button></nav></div></header>{page === 'home' && Home()}{page === 'student' && StudentLogin()}{page === 'admin' && AdminLogin()}{page === 'studentDashboard' && StudentDashboard()}{page === 'adminDashboard' && AdminDashboard()}</div>;
// // // // }
// // // import React from 'react';
...
// // //   return <div className="min-h-screen bg-gray-100 text-gray-900 overflow-x-hidden"><header className="bg-white shadow sticky top-0 z-50"><div className="max-w-7xl mx-auto px-3 sm:px-6 py-3 sm:py-4 flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4"><div className="flex items-center gap-3 w-full sm:w-auto justify-center sm:justify-start"><img src={SCHOOL_LOGO} alt="School Logo" className="w-10 h-10 sm:w-12 sm:h-12 rounded-full object-cover" /><div className="text-center sm:text-left"><h1 className="text-base sm:text-xl font-bold text-blue-700 leading-tight">{SCHOOL_NAME}</h1><p className="text-[10px] sm:text-xs text-gray-500">{SCHOOL_TAGLINE}</p></div></div><nav className="w-full sm:w-auto grid grid-cols-3 sm:flex gap-2 bg-blue-50/70 p-2 rounded-2xl border border-blue-100 shadow-inner"><button onClick={() => setPage('home')} className={page === 'home' ? 'px-3 sm:px-5 py-2 rounded-xl bg-blue-600 text-white font-bold shadow-lg transition-all duration-300 text-sm sm:text-base' : 'px-3 sm:px-5 py-2 rounded-xl font-bold text-gray-700 hover:text-blue-700 hover:bg-white hover:shadow-md transition-all duration-300 text-sm sm:text-base'}>Home</button><button onClick={() => setPage('student')} className={page === 'student' || page === 'studentDashboard' ? 'px-3 sm:px-5 py-2 rounded-xl bg-blue-600 text-white font-bold shadow-lg transition-all duration-300 text-sm sm:text-base' : 'px-3 sm:px-5 py-2 rounded-xl font-bold text-gray-700 hover:text-blue-700 hover:bg-white hover:shadow-md transition-all duration-300 text-sm sm:text-base'}>Student</button><button onClick={() => setPage(adminLoggedIn ? 'adminDashboard' : 'admin')} className={page === 'admin' || page === 'adminDashboard' ? 'px-3 sm:px-5 py-2 rounded-xl bg-blue-600 text-white font-bold shadow-lg transition-all duration-300 text-sm sm:text-base' : 'px-3 sm:px-5 py-2 rounded-xl font-bold text-gray-700 hover:text-blue-700 hover:bg-white hover:shadow-md transition-all duration-300 text-sm sm:text-base'}>Admin</button></nav></div></header>{page === 'home' && Home()}{page === 'student' && StudentLogin()}{page === 'admin' && (adminLoggedIn ? AdminDashboard() : AdminLogin())}{page === 'studentDashboard' && StudentDashboard()}{page === 'adminDashboard' && (adminLoggedIn ? AdminDashboard() : AdminLogin())}</div>;
// // // }
